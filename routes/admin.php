...
Route::post("usuarios/{persona:id}/validateForm", [ContactController::class, "validateForm"])->name("contacts.validateForm");
...
Route::get("cortes/pdf",[CortesController::class, "usePDF"])->name("cortes.pdf");
